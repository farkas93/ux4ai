...
REQUIRED_KEYS = {"language_name", "sections", "sections.Project Brief", "sections.Dimension Explorer", "sections.Notes", "sections.Hypothesis Backlog", "sections.Experiments", "sections.Summary & Export"}
...
def load_catalog(language: str) -> dict:
    ...
    if not isinstance(sections, dict) or not catalog.get("language_name"):
